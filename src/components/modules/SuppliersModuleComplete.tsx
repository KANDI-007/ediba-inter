...
const SuppliersModuleComplete: React.FC = () => {
  console.log('SuppliersModuleComplete - Component rendering');
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex space-x-1">
                  <button className="p-2 text-gray-400 hover:text-sky-600 hover:bg-sky-50 rounded-lg transition-colors duration-200" onClick={() => {
                    ...
                    setForm({ raisonSociale: supplier.raisonSociale, nif: supplier.nif, rccm: supplier.rccm || '', adresse: supplier.adresse || '', telephone: supplier.telephone || '', email: supplier.email || '', regimeFiscal: supplier.regimeFiscal || 'Réel Normal', produits: (supplier.produits || []).join(', ') });
                    setShowAddModal(true);
                  }}>
...
const SupplierInvoiceForm: React.FC<{ suppliersList: any[], addSupplierInvoice: (invoice: any) => void }> = ({ suppliersList, addSupplierInvoice }) => {
...
export default SuppliersModuleComplete;
