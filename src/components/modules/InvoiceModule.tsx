        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white w-full max-w-2xl max-h-[90vh] rounded-xl shadow-2xl overflow-hidden flex flex-col">
            ...
            <div className="p-6 space-y-4 overflow-y-auto flex-1">
              ...
              <div ref={printableRef} className="mt-6 bg-white border rounded-lg p-0" style={{ overflow: 'visible', height: 'auto', maxHeight: 'none' }}>
                <div className="mx-auto" style={{ width: '794px', overflow: 'visible', height: 'auto', maxHeight: 'none' }}>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white w-full max-w-6xl max-h-[90vh] rounded-xl shadow-2xl overflow-hidden flex flex-col">
            ...
            <div className="p-6 overflow-y-auto flex-1 bg-gray-50">
              <div ref={printableRef} style={{ overflow: 'visible', height: 'auto', maxHeight: 'none' }}>
